...
$cfg_basehost = 'http://www.sandbless.com/test';
$cfg_cmspath = '';
$cfg_cookie_encode = 'XFXlhv5DP8mu2ruBWRR0R27Okohga5';
$cfg_indexurl = '/test';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '上海洲佑信息技术有限公司';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright @ 2011-2015 上海洲佑信息技术有限公司 All Rights Reserved. ';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = 'IT外包、软件开发、视频监控、门禁系统、电子围栏、停车场一卡通、入侵防盗系统、视频会议、公共广播、楼宇对讲、电子显示屏';
$cfg_description = 'IT外包、软件开发、视频监控、门禁系统、电子围栏、停车场一卡通、入侵防盗系统、视频会议、公共广播、楼宇对讲、电子显示屏';
$cfg_beian = '沪ICP备17002819号-1';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
